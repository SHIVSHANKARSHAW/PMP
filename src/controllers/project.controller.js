...
const getProjectById = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, project, "Projecy fetched Successfully"));
});
...
const updateProject = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, project, "Projecy Updated Successfully"));
});
...
const deleteProject = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, project, "Projecy Deleted Successfully"));
});
